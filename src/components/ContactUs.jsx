		...
		<>
			<div
				...
				<div className="flex items-center justify-center min-h-screen mx-4">
					<motion.div
						className="bg-opacity-20 bg-white backdrop-blur-md border border-red-500 rounded-md p-6 max-w-xl w-full space-y-4 shadow-lg mt-[70px]"
						initial={{ height: 0 }}
						animate={{
							height: "100%",
